...
// data structure.
//
// The filter is responsible for creating small filter from a set of keys.
...
type Buffer interface {
	// Alloc allocates n bytes of slice from the buffer. This also advancing
	// write offset.
	Alloc(n int) []byte
...
type FilterGenerator interface {
	...
	// to Generate the filter generator maybe get reset, depends on implementation.
	Generate(b Buffer)
}
